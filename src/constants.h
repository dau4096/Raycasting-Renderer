...
inline const std::unordered_map<std::string, int> keyNameToGLFW = {
	...
	{"MOUSE_CENTRE", GLFW_MOUSE_BUTTON_3},
	{"MOUSE_SCROLL_UP", -2},	//Special. Not a GLFW Enum
	{"MOUSE_SCROLL_DOWN", -3}	//Special. Not a GLFW Enum
};
...
namespace playerConfig {
	...
	//Items
	constexpr int MAX_ITEMS_HELD = 4;
	constexpr std::string EMPTY_HAND_ITEM_NAME = "<NONE>";
	constexpr float SECONDS_TO_FADE_TEXT = 2.0f;
}
